...
SRC_DIR="$PROJECT_ROOT/skill/md2wechat"
DST_DIR="$PROJECT_ROOT/plugins/md2wechat/skills/md2wechat"
...
echo "  - skill/md2wechat/"
echo "  - plugins/md2wechat/skills/md2wechat/"
